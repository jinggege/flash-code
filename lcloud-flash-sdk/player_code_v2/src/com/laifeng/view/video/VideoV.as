...
{
    import com.laifeng.config.InterfaceKey;
    ...
    public class VideoV extends Sprite implements IUI{
        ...
        public function play():void {
			...
			var interfaceData:Object = {};
			interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_SUCCESS;
			interfaceData.param = {};
			LFExtenrnalInterface.get.globelCallJs(interfaceData);
        }
		...
		private function callbackByVideo(data:CallbackData):void{
			...
			switch(data.callbackType){
				case "NetStream.Play.StreamNotFound" :
					...
					interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_ERROR;
					interfaceData.param = {errorCode:3000,msg:"流不存在!"};
					LFExtenrnalInterface.get.globelCallJs(interfaceData);
					break;
				...
				case "NetStream.Buffer.Full":
					...
					interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_BUFFER_FULL;
					interfaceData.param = {};
					LFExtenrnalInterface.get.globelCallJs(interfaceData);
				...
				case "NetStream.Buffer.Empty":
					...
					interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_BUFFER_EMPTY;
					interfaceData.param = {};
					LFExtenrnalInterface.get.globelCallJs(interfaceData);
				...
				case CallbackType.CT_ONMETADATA :
						...
						interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_METADA;
						interfaceData.param = data;
						LFExtenrnalInterface.get.globelCallJs(interfaceData);
		...
		private function changePauseHandler(event:MEvent):void{
			...
			switch(status){
				case NoticeKey.TYPE_VIDEO_STATUS_PAUSE:
					_cVideo.pause();
					this._isPause = true;
					interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_PAUSE;
					interfaceData.param = {};
					LFExtenrnalInterface.get.globelCallJs(interfaceData);
					break;
				case NoticeKey.TYPE_VIDEO_STATUS_PLAYING:
					_cVideo.resume();
					this._isPause = false;
					interfaceData.interfaceType = InterfaceKey.ITYPE_PLAY_RESUME;
					interfaceData.param = {};
					LFExtenrnalInterface.get.globelCallJs(interfaceData);
					break;
			}
