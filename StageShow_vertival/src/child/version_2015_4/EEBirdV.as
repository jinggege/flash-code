package child.version_2015_4
{
	...
	public class EEBirdV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_bird;
		/**唯一标识*/
		private var _sign:*;
		
		public function EEBirdV()
		{
			super();
			_instance = new Skin_bird();
			addChild(_instance);
			_instance.x = 430;
			_instance.y = 170;
		...
		public function set param(value:Object):void
		{
			...
			var tff:TextFormat = YaHeiFormat.getYaHeiFormat(14,0x663300,"left");
