package child.superman
{
	...
	public class StageSupermanV_1 extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_superman;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageSupermanV_1()
		{
			super();
			_instance = new Skin_superman();
			addChild(_instance);
			_instance.x = 550;
			_instance.y = 165;
