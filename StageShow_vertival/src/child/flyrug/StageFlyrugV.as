package child.flyrug
{
	...
	public class StageFlyrugV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_flyrug;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageFlyrugV()
		{
			super();
			_instance = new Skin_flyrug();
			addChild(_instance);
			_instance.x = 437;
			_instance.y = 162;
