package child.girlshow
{
	 ...
	 * 显示用户等级    名称(需限制长度)
	 */
	public class GirlInStageV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:HotGril;
		/**唯一标识*/
		private var _sign:*;
		
		public function GirlInStageV()
		{
			super();
			_instance = new HotGril();
			addChild(_instance);
			_instance.y +=30;
