package child.skateboard
{
	...
	public class StageSkateboardV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_skateboard;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageSkateboardV()
		{
			super();
			_instance = new Skin_skateboard();
			addChild(_instance);
			_instance.x = 520;
			_instance.y = 181;
