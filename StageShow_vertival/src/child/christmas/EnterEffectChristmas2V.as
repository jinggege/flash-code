package child.christmas
{
	...
	public class EnterEffectChristmas2V extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:LibEnterChristmas1;
		
		/**唯一标识*/
		private var _sign:*;
		
		public function EnterEffectChristmas2V()
		{
			super();
			_instance = new LibEnterChristmas1();
			addChild(_instance);
			_instance.x = 427;
			_instance.y = 150;
