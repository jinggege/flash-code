package child.shopping
{
	...
	public class EnterEffectCar1V extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:LibEnterCar1;
		/**唯一标识*/
		private var _sign:*;
		
		public function EnterEffectCar1V()
		{
			super();
			_instance = new LibEnterCar1();
			addChild(_instance);
			_instance.x = 427;
			_instance.y = 135;
