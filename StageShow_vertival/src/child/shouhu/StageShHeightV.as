package child.shouhu
{
	...
	public class StageShHeightV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_shouhu_height;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageShHeightV()
		{
			super();
			_instance = new Skin_shouhu_height();
			addChild(_instance);
			_instance.x = 550;
			_instance.y = 165;
			...
			_instance.addEventListener("E_CHILD_PLAY_FRAME_30",customFrame);
		}
		...
		private function addLevelIcon(data:Object):void
		{
			...
			img.y = tfName.y+tfName.height/2 -img.height/2;
		}
		
		
		
		private function customFrame(event:Event):void{
			_instance.childMc.gotoAndPlay(2);
		}
		...
		public function destroy():void
		{
			...
			_instance.removeEventListener("E_CHILD_PLAY_FRAME_30",customFrame);
			_instance.stop();
