package child.shouhu
{
	...
	public class StageShLowV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_shouhu_low;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageShLowV()
		{
			super();
			_instance = new Skin_shouhu_low();
			addChild(_instance);
			_instance.x = 550;
			_instance.y = 165;
