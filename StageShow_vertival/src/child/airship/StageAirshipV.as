package child.airship
{
	...
	public class StageAirshipV extends Sprite implements IEffect
	{
		private var _param:Object;
		/**回调*/
		private var _callback:Function;
		
		private var _instance:Skin_airship;
		/**唯一标识*/
		private var _sign:*;
		
		public function StageAirshipV()
		{
			super();
			_instance = new Skin_airship();
			addChild(_instance);
			_instance.x = 520;
			_instance.y = 175;
